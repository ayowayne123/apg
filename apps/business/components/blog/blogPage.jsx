...
export default function BlogPage({ blog }) {
  const hasCoverPhoto = !!blog?.cover_photo?.url;

  return (
    <article className="container py-16 ">
      {/* Cover Photo / Fallback */}
      <div
        className={`h-[400px] rounded-[35px] w-full relative overflow-hidden mb-3 ${
          !hasCoverPhoto ? "bg-[#121212] bg-no-repeat bg-center" : ""
        }`}
        style={
          !hasCoverPhoto
