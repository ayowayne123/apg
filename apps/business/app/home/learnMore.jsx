    ...
    <section className="grid lg:grid-cols-2 lg:py-20 py-16 xl:px-8 lg:px-4 relative">
      <div className="grid grid-cols-2 lg:px-6 px-4 sm:px-9 gap-5 relative">
        ...
        <div className="flex flex-col gap-5 z-20">
          <motion.div
            className="relative w-full lg:h-[267px] h-[225px] sm:h-[300px] overflow-hidden rounded-[30px]"
          ...
          <motion.div
            className="relative w-full lg:h-[193px] h-[150px] sm:h-[200px] overflow-hidden rounded-[30px]"
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
        ...
        <div className="flex flex-col gap-5 pt-8 sm:pt-12 z-20">
          <motion.div
            className="relative w-full lg:h-[298px] h-[250px] sm:h-[315px] overflow-hidden rounded-[30px]"
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
          ...
          <motion.div
            className="relative w-full lg:h-[217px] h-[180px] sm:h-[230px] overflow-hidden rounded-[30px]"
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
      ...
      <motion.div
        className="text-primary lg:ml-6 xl:ml-20 pt-12"
